...
#SPRITE_DIR_PATH = 'Tetris\Assents\Sprites'
FONT_PATH = 'Tetris\Assents\Fonts\Designer.otf'

ANIM_TIME_INTERVAL = 150
FAST_ANIM_TIME_INTERVAL = 15

TILE_SIZE = 30
FIELD_SIZE = FIELD_W, FIELD_H = 15, 25
...
ProgramIcon = pygame.image.load('Tetris/Assents/Logo.png')